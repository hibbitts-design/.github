...
With the aim to help teams and individual educators create better online experiences for their students, the [Canvas LMS site](https://canvas.sfu.ca/courses/69678) and [Standalone site](https://paulhibbitts.github.io/cmpt-363) for my most recent highly successful offering of SFU CMPT-363 User Interface Design (which was re-designed as an online and more scalable variation of the traditional 3rd-year face-to-face course) will remain public.
